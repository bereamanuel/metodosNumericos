...
%Este método calcula el resultado del problema del valor inicial de %una función dada en un intervalo mediante el método de Euler %Implícito.
%INPUT:
...
for k=1:N
   ...
   %Salimos del bucle, cuando conseguimos un máximo de iteraciones o 
   %la diferencia es menor a la tolerancia que especificamos.
